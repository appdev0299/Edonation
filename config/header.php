    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="mainNavigation">
        <ul class="navbar-nav ml-auto">
          <li class="nav__item">
            <a href="contact-us.html" class="nav__item-link active">หน้าหลัก</a>
          </li>
          <li class="nav__item">
            <a href="contact-us.html" class="nav__item-link">รายนามผู้บริจาค</a>
          </li>
          <li class="nav__item has-dropdown">
            <a href="#" data-toggle="dropdown" class="dropdown-toggle nav__item-link">สิทธิประโยชน์</a>
            <ul class="dropdown-menu">
              <li class="nav__item">
                <a href="about-us.html" class="nav__item-link">ของที่ระลึก</a>
              </li><!-- /.nav-item -->
              <li class="nav__item">
                <a href="services.html" class="nav__item-link">เครื่องราชอิสริยาภรณ์</a>
              </li><!-- /.nav-item -->
            </ul><!-- /.dropdown-menu -->
          </li><!-- /.nav-item -->
      ...
      <div class="d-none d-xl-flex align-items-center position-relative ml-30">
        <div class="miniPopup-departments-trigger">
          ...
          <a href="departments.html">คู่มือการบริจาค</a>
        </div>
